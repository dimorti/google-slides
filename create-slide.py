...
def main():
    ...
    try:
        ...
        presentation = ss.create_presentation('The collaborations of IBM with 24 Russell Group Universities across the UK')
        ss.create_slide(presentation['presentationId'], 5)
